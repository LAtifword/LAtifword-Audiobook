...
/** Foreground audiobook renderer for LATIF Voice Studio v3.2.1 Author Narrator. */
class AudiobookService : Service() {
    ...
    private fun runJob(
        ...
        try {
            ...
            val reference = if (referenceUri != null) {
                sendProgress(4, "Preparing narrator voice…")
    ...
    private fun notification(message: String, progress: Int, ongoing: Boolean): Notification {
        ...
        return Notification.Builder(this, CHANNEL_ID)
            .setContentTitle("LATIF Voice Studio 3.2.1 · Author Narrator")
